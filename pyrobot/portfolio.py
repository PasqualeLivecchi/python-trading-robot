...
class Portfolio():
    ...
    def remove_position(self, symbol: str) -> Tuple[bool, str]:
        ...
        if symbol in self.positions:
            ...
            return (False, f"{symbol} did not exist in the porfolio.")
    ...
    def portfolio_metrics(self) -> dict:
        ...
        returns_avg = self._stock_frame_daily.symbol_groups['daily_returns_avg'].tail(n=1).to_dict()

        returns_std = self._stock_frame_daily.symbol_groups['daily_returns_std'].tail(n=1).to_dict()
